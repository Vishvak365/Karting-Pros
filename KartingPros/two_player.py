...
import pygame
from KartingPros import screen, track, mainmenu
# import screen
# import track
import time
# import mainmenu
...
def win2(display_surface):
    ...
    win = pygame.image.load(r'/KartingPros/images/win.png')
...
def two_player(display_surface):
    ...
    car = Car(r'/KartingPros/images/f1sprite.png', startcar)
    car_group = pygame.sprite.Group(car)

    car2 = Car(r'/KartingPros/images/f1sprite.png', startcar2)
    ...
    while True:
        ...
        carlap1 = font.render("Car 1 Laps completed: " +
                              str(lapcar1) + "/5", True, (255, 255, 255))
        carlap2 = font.render("Car 2 Laps completed: " +
                              str(lapcar2) + "/5", True, (255, 255, 255))
